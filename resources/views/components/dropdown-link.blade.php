...
=======
<a {{ $attributes->merge(['class' => 'block w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 dark:text-gray-300 hover:bg-orange-100 dark:hover:bg-gray-700 dark:hover:text-orange-400 focus:outline-none focus:bg-orange-100 dark:focus:bg-gray-700 transition duration-150 ease-in-out']) }}>{{ $slot }}</a>
