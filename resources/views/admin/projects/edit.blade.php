...
<div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(59,130,246,0.18);">
    <div class="acc-header" id="acc-advance-hdr" onclick="toggleAcc('advance')"
         role="button" aria-expanded="true" aria-controls="acc-advance-bdy"
...
<div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(168,85,247,0.18);">
    <div class="acc-header" id="acc-retention-hdr" onclick="toggleAcc('retention')"
         role="button" aria-expanded="true" aria-controls="acc-retention-bdy"
