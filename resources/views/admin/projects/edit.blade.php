<x-app-layout>
    ...
    {{-- ============================================================
    PHP PREP — build TE / VO / SO history arrays
    ============================================================ --}}
    @php
    ...
    <div class="max-w-5xl mx-auto fade-up" style="padding:0 1.5rem;">
        ...
        @if(session('success'))
            <div
                style="background:rgba(22,163,74,0.08); border:1px solid rgba(22,163,74,0.25); border-radius:10px; padding:1rem; margin-bottom:1.5rem; display:flex; align-items:center; gap:0.6rem;">
        ...
        <form method="POST" action="{{ route('admin.projects.update', $project) }}">
            ...
            <div
                ...
                <button type="button" class="tab-btn tab-active" data-tab="tab-overview"
                    onclick="switchTab('tab-overview', this)">
                    <i class="fas fa-info-circle" style="font-size:0.8rem;"></i> <span>Overview</span>
                </button>
                <button type="button" class="tab-btn" data-tab="tab-progress" onclick="switchTab('tab-progress', this)">
                    <i class="fas fa-chart-line" style="font-size:0.8rem;"></i> <span>Performance</span>
                </button>
                <button type="button" class="tab-btn" data-tab="tab-extensions"
                    onclick="switchTab('tab-extensions', this)">
                    <i class="fas fa-file-alt" style="font-size:0.8rem;"></i> <span>Extensions</span>
                </button>
                <button type="button" class="tab-btn" data-tab="tab-171" onclick="switchTab('tab-171', this)">
                    <i class="fas fa-file-invoice-dollar" style="font-size:0.8rem;"></i> <span>Billing</span>
                </button>
                <button type="button" class="tab-btn" data-tab="tab-admin" onclick="switchTab('tab-admin', this)">
                    <i class="fas fa-cog" style="font-size:0.8rem;"></i> <span>Admin</span>
                </button>
            </div>
            ...
            <div id="tab-overview" class="tab-content active">
                ...
                <div class="form-card" style="margin-bottom:1.5rem;">
                    <div class="section-header">
                        ...
                        <span
                            style="margin-left:auto; font-size:0.7rem; color:#9ca3af; font-weight:400;">Read-only</span>
                    </div>
                    ...
                    <div class="section-body">
                        <div class="grid-2col">
                            ...
                            <div class="field-group" style="grid-column:1/-1;">
                                ...
                                <p
                                    style="font-size:0.9rem; font-weight:800; color:var(--text-primary); margin:0; padding:0.1rem 0; font-family:'Syne',sans-serif; letter-spacing:-0.01em;">
                                    #{{ $project->contract_id }}
                                </p>
                            </div>
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" name="original_contract_amount" id="original_contract_amount"
                                    class="field-input" data-amount
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" name="location" class="field-input"
                                    value="{{ old('location', $project->location) }}" placeholder="Project location"
                                    required>
                                @error('location')
                                    <p class="field-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</p>
                                @enderror
                            ...
                            <div class="field-group">
                                <label class="field-label">
                                    Status <span style="font-weight:400; color:#9ca3af;">(auto)</span>
                                </label>
                                ...
                                <div style="display:flex; align-items:center; gap:0.75rem; flex-wrap:wrap;">
                                    ...
                                    @elseif($daysLeft < 0)
                                        <span
                                            style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.4rem 0.85rem;border-radius:99px;background:rgba(239,68,68,0.1);color:#dc2626;font-size:0.8rem;font-weight:700;">
                                            <span
                                                style="width:7px;height:7px;border-radius:50%;background:#dc2626;display:inline-block;"></span>
                                            Expired
                                        </span>
                                    @elseif($daysLeft <= 30)
                                        <span
                                            style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.4rem 0.85rem;border-radius:99px;background:rgba(245,158,11,0.1);color:#d97706;font-size:0.8rem;font-weight:700;">
                                            <span
                                                style="width:7px;height:7px;border-radius:50%;background:#f59e0b;animation:pulse 1.5s ease infinite;display:inline-block;"></span>
                                            Expiring Soon
                                        </span>
                                    @else
                                        <span
                                ...
                                {{-- Reactivate panel (completed projects only) --}}
                                @if($project->status === 'completed')
                                    <div id="reactivate-section"
                                        style="display:none; margin-top:0.875rem; padding:1rem; border-radius:10px; border:1.5px solid rgba(59,130,246,0.2); background:rgba(59,130,246,0.04);">
                                        <div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:0.6rem;">
                                            <i class="fas fa-rotate-left" style="color:#2563eb; font-size:0.8rem;"></i>
                                            <label class="field-label" style="margin:0; color:#2563eb;">Reactivate this
                                                project?</label>
                                        </div>
                                        <p style="font-size:0.78rem; color:var(--text-secondary); margin:0 0 0.75rem;">
                                            ...
                                            <strong style="color:var(--text-primary);">
                                                {{ ($project->revised_contract_expiry ?? $project->original_contract_expiry)->format('F d, Y') }}
                                            </strong>
                                        </p>
                                ...
                                <div id="complete-section"
                                    style="display:{{ $project->status === 'completed' ? 'block' : 'none' }}; margin-top:0.875rem; padding:1rem; border-radius:10px; border:1.5px solid rgba(22,163,74,0.2); background:rgba(22,163,74,0.04);">
                                    <div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:0.75rem;">
                                        <i class="fas fa-calendar-check" style="color:#16a34a; font-size:0.8rem;"></i>
                                        <label class="field-label" style="margin:0; color:#16a34a;">Date
                                            Completed</label>
                                    </div>
                                    ...
                                    <p class="field-hint" style="margin-top:0.4rem; color:#16a34a;">
                                        <i class="fas fa-info-circle"></i> Saving with this date will mark the project
                                        as completed.
                                    </p>
                                    @if($project->status !== 'completed')
                                        <button type="button" onclick="toggleCompleteSection()"
                                ...
                                @if($project->status !== 'completed')
                                    <p class="field-hint" style="margin-top:0.4rem;">Auto-determined from expiry date ·
                                        override by marking complete</p>
                                @else
                                    <p class="field-hint" style="margin-top:0.4rem; color:#16a34a;">
                ...
                </div>{{-- /form-card: Project Information --}}
                ...
                <div class="form-card" style="margin-bottom:1.5rem;">
                    <div class="section-header">
                        ...
                        <span style="margin-left:auto; font-size:0.7rem; color:#9ca3af; font-weight:400;">Key
                            milestones</span>
                    </div>
                        ...
                        <div class="grid-2col">
                            <div class="field-group">
                                ...
                                <p
                                    ...
                                    {{ $project->date_started->format('F d, Y') }}
                                </p>
                            ...
                            <div class="field-group">
                                ...
                                @if($project->revised_contract_expiry)
                                    <p
                                        style="font-size:0.9rem; font-weight:700; color:#f97316; margin:0; padding:0.1rem 0; font-family:'Syne',sans-serif;">
                                        {{ $project->revised_contract_expiry->format('F d, Y') }}
                                    </p>
                                    <p class="field-hint">{{ $project->revised_contract_expiry->format('l') }}</p>
                                @else
                                    <p
                                        style="font-size:0.875rem; color:#9ca3af; margin:0; padding:0.1rem 0; font-style:italic;">
                                        Not yet set</p>
                                @endif
                            </div>
                        </div>
                    </div>
                </div>{{-- /form-card: Contract Dates --}}
                ...
                <div class="form-card" style="margin-bottom:1.5rem;">
                    ...
                    <div class="section-body">
                        <div class="grid-2col">
                            <div class="field-group">
                                ...
                                <input type="number" name="as_planned" id="as_planned" class="field-input"
                                    value="{{ old('as_planned', $project->as_planned) }}" min="0" max="100" step="0.001"
                                ...
                                <div class="prog-bar-track">
                                    <div class="prog-bar-fill" id="ap_bar"
                                        style="background:var(--orange-500); width:{{ $project->as_planned }}%;"></div>
                                </div>
                                @error('as_planned')
                                    <p class="field-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</p>
                                @enderror
                            ...
                            <div class="field-group">
                                ...
                                <input type="number" name="work_done" id="work_done" class="field-input"
                                    value="{{ old('work_done', $project->work_done) }}" min="0" max="100" step="0.001"
                                    required style="padding-right:2.5rem;"
                                    onkeydown="return event.key !== '-' && event.key !== 'e'"
                                    oninput="if(parseFloat(this.value)>100)this.value=100; computeSlippage()">
                                <div class="prog-bar-track">
                                    <div class="prog-bar-fill" id="wd_bar"
                                        style="background:#3b82f6; width:{{ $project->work_done }}%;"></div>
                                </div>
                                @error('work_done')
                                    <p class="field-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</p>
                                @enderror
                        ...
                        <div class="field-group">
                            ...
                            <input type="hidden" name="slippage" id="slippage"
                                value="{{ old('slippage', $project->slippage) }}">
                            <div id="slippage-display"
                                style="display:flex; align-items:center; justify-content:space-between; padding:0.85rem 1rem; border:1.5px solid rgba(26,15,0,0.08); border-radius:9px; background:var(--bg-secondary); min-height:48px;">
                                <p id="slippage_label"
                                    style="font-size:0.85rem; font-weight:600; color:#9ca3af; margin:0;">
                                    <i class="fas fa-minus"></i> On schedule
                                </p>
                                <span id="slippage-value"
                                    style="font-family:'Syne',sans-serif; font-size:1.25rem; font-weight:800; color:#9ca3af;">—</span>
                            </div>
                        </div>
                            ...
                            <div class="field-group">
                                ...
                                <div class="info-box">
                                    ...
                                    <span style="font-size:0.845rem; color:var(--text-secondary);">
                                        ...
                                        — <span
                                            style="color:var(--orange-600); font-weight:600;">{{ $project->progress_updated_at->diffForHumans() }}</span>
                                    </span>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="section-body">
                        <div class="grid-2col">
                            ...
                            <div class="field-group">
                                <label class="field-label">
                                    Unworked (%) <span
                                        style="font-weight:400; text-transform:none; letter-spacing:0; color:#9ca3af;">(auto)</span>
                                </label>
    ...
    : 'Original Expiry: ' . $project->original_contract_expiry->format('M d, Y') }}
                                ...
                                <p class="field-hint" id="ld_overdue_hint">
                                    ...
                                    {{ $project->revised_contract_expiry ? 'revised' : 'original' }} contract expiry
                                </p>
                            </div>
                            ...
                            <div class="field-group">
                                ...
                                <p
                                    style="font-size:0.9rem; font-weight:700; color:var(--text-primary); margin:0; padding:0.1rem 0; font-family:'Syne',sans-serif; letter-spacing:-0.01em;">
                                    ₱<span
                ...
                </div>{{-- /form-card: Liquidated Damages --}}
            ...
            <div id="tab-extensions" class="tab-content">
                ...
                <div class="form-card" style="margin-bottom:1.5rem;">
                    <div class="acc-header" id="acc-te-hdr" onclick="toggleAcc('te')" role="button" aria-expanded="true"
                        aria-controls="acc-te-bdy">
                        ...
                        @else
                            <span style="font-size:0.7rem; color:#9ca3af; margin-left:0.4rem; font-weight:400;">No entries
                                yet</span>
                        @endif
                        <div class="acc-status-dot" style="background:{{ $teCount > 0 ? '#16a34a' : '#d1d5db' }};">
                        </div>
                    ...
                    <div class="acc-body is-collapsed" id="acc-te-bdy">
                        <div class="acc-body-inner">
                            <div class="section-body">
                                ...
                                @if($teCount > 0)
                                    <div style="margin-bottom:1.5rem;">
                                        <p
                                            ...
                                            <i class="fas fa-history" style="color:var(--orange-500);"></i> Existing Time
                                            Extensions
                                        </p>
                                        <div
                                        ...
                                        <div class="history-timeline">
                                            ...
                                            @foreach($teHistory as $ti => $entry)
                                                @php
                                                    $teRunning += $entry['days'];
                                                    $teIsLast = $ti === count($teHistory) - 1;
                                                @endphp
                                                <div class="history-entry te-entry" style="align-items:start;">
                                                    <div class="h-spine">
                                                        <div class="h-dot h-dot-orange"></div>
                                                        @if(!$teIsLast)
                                                        <div class="h-line h-line-orange"></div>@endif
                                                    </div>
                                                    <div class="h-label {{ $teIsLast ? 'last' : '' }}"
                                                        style="display:flex; align-items:flex-start; flex-direction:column; gap:0.2rem;">
                                                        ...
                                                        <span style="display:flex; gap:0.4rem; flex-wrap:wrap;">
                                                            @if($entry['date_requested'])
                                                                <span style="font-size:0.72rem; font-weight:500; color:#9ca3af;">
                                                                    {{ \Carbon\Carbon::parse($entry['date_requested'])->format('M d, Y') }}
                                                                </span>
                                                            @endif
                                                            @if($entry['cost'])
                                                                <span style="font-size:0.72rem; font-weight:500; color:#16a34a;">
                                                                    ₱{{ number_format($entry['cost'], 2) }}
                                                                </span>
                                                            @endif
                                                        </span>
                                                    </div>
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            onclick="openEditModal('te', {{ $ti }}, '{{ addslashes($entry['label']) }}', {{ $entry['days'] }}, '{{ $entry['cost'] ?? '' }}', '{{ $entry['date_requested'] ?? '' }}', '{{ addslashes($entry['reason'] ?? '') }}')"
                                        ...
                                        <div class="h-summary">
                                            <span
                                                ...
                                                <i class="fas fa-sigma"
                                                    style="color:var(--orange-500); font-size:0.75rem;"></i>
                                                Total across {{ $teCount }}
                                                {{ $teCount === 1 ? 'extension' : 'extensions' }}
                                            </span>
                                            <span
                                                style="font-family:'Syne',sans-serif; font-size:1.2rem; font-weight:800; color:var(--orange-600);">{{ $teRunning }}
                                                days</span>
                                        </div>
                                    </div>
                                ...
                                {{-- Add new TE --}}
                                <p
                                    style="font-size:0.65rem; font-weight:700; text-transform:uppercase; letter-spacing:0.08em; color:#9ca3af; margin-bottom:0.875rem; display:flex; align-items:center; gap:0.5rem;">
                                    <i class="fas fa-plus-circle" style="color:var(--orange-500);"></i>
                                    Add Time Extension {{ $nextTeNumber }}
                                    <span
                                        style="font-weight:500; color:#9ca3af; text-transform:none; letter-spacing:0;">
                                        — will be saved as <strong style="color:var(--orange-600);">TE
                                            {{ $nextTeNumber }}</strong>
                                    </span>
                                </p>
                                <div class="grid-2col">
                                    <div class="field-group">
                                        <label class="field-label">Extension Days <span
                                                style="color:#ef4444;">*</span></label>
                                        <input type="number" name="new_te_days" id="new_te_days" class="field-input"
                                            min="1" step="1" placeholder="e.g. 60"
                                            onkeydown="return event.key !== '-' && event.key !== 'e'"
                                            oninput="updateTEPreview()">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div style="position:relative;">
                                            <span
                                                style="position:absolute; left:1rem; top:50%; transform:translateY(-50%); color:var(--ink-muted); font-weight:600; pointer-events:none;">₱</span>
                                            <input type="text" name="new_te_cost" class="field-input" data-amount
                                                inputmode="decimal" placeholder="0.00" style="padding-left:1.75rem;">
                                        </div>
                                    ...
                                    <div class="field-group" style="grid-column:1/-1;">
                                        ...
                                        <div
                                            style="padding:0.875rem 1rem; border:1.5px solid rgba(249,115,22,0.2); border-radius:9px; background:rgba(249,115,22,0.04); display:flex; align-items:center; gap:0.6rem; min-height:46px;">
                                            <i class="fas fa-calendar-check" style="color:var(--orange-500);"></i>
                                            <span id="te_revised_preview"
                                                style="font-weight:600; color:var(--text-primary);">Enter days above to
                                                preview</span>
                                        </div>
                                    </div>
                                </div>
                ...
                </div>{{-- /form-card: Time Extensions --}}

                {{-- ── Variation Orders accordion ── --}}
                <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(99,102,241,0.18);">
                    <div class="acc-header acc-indigo" id="acc-vo-hdr" onclick="toggleAcc('vo')" role="button"
                        aria-expanded="true" aria-controls="acc-vo-bdy"
                        style="border-bottom-color:rgba(99,102,241,0.15);">
                        ...
                        @if($voCount > 0)
                            <span class="tag-chip tag-chip-indigo" style="margin-left:0.4rem;">{{ $voCount }}
                                recorded</span>
                        @else
                            <span style="font-size:0.7rem; color:#9ca3af; margin-left:0.4rem; font-weight:400;">No entries
                                yet</span>
                        @endif
                        <div class="acc-status-dot" style="background:{{ $voCount > 0 ? '#6366f1' : '#d1d5db' }};">
                        </div>
                        <div class="acc-chevron" style="border-color:rgba(99,102,241,0.2);"><i
                        ...
                        <div class="acc-body-inner">
                            <div class="section-body">
                                    ...
                                    <div style="margin-bottom:1.5rem;">
                                        ...
                                        <div class="history-timeline">
                                            ...
                                            @foreach($voHistory as $vi => $entry)
                                                @php
                                                    $voRunning += $entry['days'];
                                                    $voIsLast = $vi === count($voHistory) - 1;
                                                @endphp
                                                <div class="history-entry vo-entry" style="align-items:start;">
                                                    <div class="h-spine">
                                                        <div class="h-dot h-dot-indigo"></div>
                                                        @if(!$voIsLast)
                                                        <div class="h-line h-line-indigo"></div>@endif
                                                    </div>
                                                    <div class="h-label {{ $voIsLast ? 'last' : '' }}"
                                                        style="display:flex; align-items:flex-start; flex-direction:column; gap:0.2rem;">
                                                        <span>{{ $entry['label'] }}</span>
                                                        <span style="display:flex; gap:0.4rem; flex-wrap:wrap;">
                                                            @if($entry['date_requested'])
                                                    ...
                                                    <div
                                                        style="display:flex; align-items:flex-start; justify-content:center; padding-top:2px;">
                                                        <button type="button"
                                                            onclick="openEditModal('vo', {{ $vi }}, '{{ addslashes($entry['label']) }}', {{ $entry['days'] }}, '{{ $entry['cost'] ?? '' }}', '{{ $entry['date_requested'] ?? '' }}', '{{ addslashes($entry['reason'] ?? '') }}')"
                                        ...
                                        @php $voStackedTotal = $existingTETotal + $voRunning; @endphp
                                        <div class="h-summary">
                                            <span
                                                style="font-size:0.8rem; font-weight:600; color:var(--ink-muted); display:flex; align-items:center; gap:0.4rem;">
                                            ...
                                            <span
                                                style="font-family:'Syne',sans-serif; font-size:1.2rem; font-weight:800; color:#6366f1;">{{ $voStackedTotal }}
                                                days</span>
                                        </div>
                                    </div>
                                ...
                                <p
                                    ...
                                    <span
                                        style="font-weight:500; color:#9ca3af; text-transform:none; letter-spacing:0;">
                                        — will be saved as <strong style="color:#6366f1;">VO
                                            {{ $nextVoNumber }}</strong>
                                    </span>
                                </p>
                                <div class="grid-2col">
                                    <div class="field-group">
                                        ...
                                        <input type="number" name="new_vo_days" id="new_vo_days" class="field-input"
                                            min="1" step="1" placeholder="e.g. 45"
                                            style="border-color:rgba(99,102,241,0.25);"
                                            onkeydown="return event.key !== '-' && event.key !== 'e'"
                                            oninput="updateVOPreview()">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <p class="field-hint"><i class="fas fa-minus"
                                                style="color:#ef4444; font-size:0.6rem;"></i> Use a negative value to
                                            deduct; positive to add to the contract amount</p>
                                    </div>
                                    <div class="field-group">
                                        <label class="field-label">Date Requested</label>
                                    ...
                                    <div class="field-group" style="grid-column:1/-1;">
                                        <label class="field-label">Projected New Expiry (Preview)</label>
                                        <div
                                            style="padding:0.875rem 1rem; border:1.5px solid rgba(99,102,241,0.2); border-radius:9px; background:rgba(99,102,241,0.04); display:flex; align-items:center; gap:0.6rem; min-height:46px;">
                                            <i class="fas fa-calendar-check" style="color:#6366f1;"></i>
                                            <span id="vo_revised_preview"
                                                style="font-weight:600; color:var(--text-primary);">Enter days above to
                                                preview</span>
                                        </div>
                                        <p class="field-hint" style="margin-top:0.4rem;">
                                            ...
                                            @if($existingTETotal > 0 || $existingVOTotal > 0)
                                                (Original{{ $existingTETotal > 0 ? ' +' . $existingTETotal . 'd TE' : '' }}{{ $existingVOTotal > 0 ? ' +' . $existingVOTotal . 'd VO' : '' }}
                                                + new VO days)
                                            @endif
                                        </p>
                                    </div>
                ...
                </div>{{-- /form-card: Variation Orders --}}

                {{-- ── Suspension Order accordion ── --}}
                <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(234,179,8,0.2);">
                    <div class="acc-header acc-yellow" id="acc-so-hdr" onclick="toggleAcc('so')" role="button"
                        aria-expanded="true" aria-controls="acc-so-bdy"
                        style="border-bottom-color:rgba(234,179,8,0.18);">
                        ...
                        @if($hasSO)
                            <span style="margin-left:0.4rem; font-size:0.7rem; color:#9ca3af; font-weight:400;">
                                Currently <strong style="color:#d97706;">{{ $project->suspension_days }} days</strong>
                                suspended
                            </span>
                        @endif
                        <div class="acc-status-dot" style="background:{{ $hasSO ? '#d97706' : '#d1d5db' }};"></div>
                        <div class="acc-chevron" style="border-color:rgba(234,179,8,0.25);"><i
                                class="fas fa-chevron-down"></i></div>
                    </div>
                        ...
                        <div class="acc-body-inner">
                            <div class="section-body">
                                <div class="grid-2col">
                                    <div class="field-group">
                                        <label class="field-label">
                                            {{ $hasSO ? 'Additional' : '' }} Suspension Days <span
                                                style="color:#ef4444;">*</span>
                                        </label>
                                        <input type="number" name="new_so_days" id="new_so_days" class="field-input"
                                            min="1" step="1" placeholder="e.g. 30"
                                            onkeydown="return event.key !== '-' && event.key !== 'e'"
                                            oninput="updateSOPreview()">
                                        <p class="field-hint">
                                    ...
                                    <div class="field-group">
                                        <label class="field-label">Projected New Expiry (Preview)</label>
                                        <div
                                            style="padding:0.875rem 1rem; border:1.5px solid rgba(234,179,8,0.25); border-radius:9px; background:rgba(234,179,8,0.04); display:flex; align-items:center; gap:0.6rem; min-height:46px;">
                                            <i class="fas fa-calendar-check" style="color:#d97706;"></i>
                                            <span id="so_revised_preview"
                                                style="font-weight:600; color:var(--text-primary);">Enter days to
                                                preview</span>
                                        </div>
                                    </div>
                                    <div
                                        style="grid-column:1/-1; padding:0.875rem 1rem; border-left:3px solid #d97706; background:rgba(234,179,8,0.04); border-radius:6px;">
                                        <p
                                            style="font-size:0.8rem; color:var(--text-primary); margin:0 0 0.4rem 0; font-weight:600;">
                                            <i class="fas fa-info-circle"
                                                style="color:#d97706; margin-right:0.4rem;"></i> How SO affects dates
                                        </p>
                                        <p
                                            style="font-size:0.75rem; color:var(--text-secondary); margin:0; line-height:1.6;">
                                            SO days stack on top of any existing TE and VO days, pushing the Revised
                                            Expiry further.
                                            @if($hasSO)
                                                <br>Current SO total: <strong
                                                    style="color:#d97706;">{{ $project->suspension_days }} days</strong>.
                                                New days will be added.
                                            @endif
                                        </p>
                                    </div>
                                </div>
                ...
                </div>{{-- /form-card: Suspension Order --}}
            ...
            <div id="tab-171" class="tab-content">
                ...
                {{-- 171 Billing accordion --}}
                <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(34,197,94,0.18);">
                    <div class="acc-header" id="acc-billing-hdr" onclick="toggleAcc('billing')" role="button"
                        aria-expanded="true" aria-controls="acc-billing-bdy"
                        style="border-bottom-color:rgba(34,197,94,0.15);">
                        <i class="fas fa-file-invoice-dollar"
                            style="color:#16a34a; font-size:0.85rem; flex-shrink:0;"></i>
                        <span class="acc-title">171</span>
                        @if($billingCount > 0)
                            <span class="tag-chip"
                                style="margin-left:0.4rem; background:rgba(34,197,94,0.1); color:#16a34a; border-color:rgba(34,197,94,0.25);">{{ $billingCount }}
                                recorded</span>
                        @else
                            <span style="font-size:0.7rem; color:#9ca3af; margin-left:0.4rem; font-weight:400;">No entries
                                yet</span>
                        @endif
                        <div class="acc-status-dot" style="background:{{ $billingCount > 0 ? '#16a34a' : '#d1d5db' }};">
                        </div>
                        <div class="acc-chevron" style="border-color:rgba(34,197,94,0.2);"><i
                                class="fas fa-chevron-down"></i></div>
                    </div>
                    ...
                    <div class="acc-body is-collapsed" id="acc-billing-bdy">
                        <div class="acc-body-inner">
                            <div class="section-body">
                                ...
                                <div class="grid-2col">
                                    <div class="field-group">
                                        <label class="field-label">Billing Amount (₱) <span
                                                style="color:#ef4444;">*</span></label>
                                        <div style="position:relative;">
                                            <span
                                                style="position:absolute; left:1rem; top:50%; transform:translateY(-50%); color:var(--ink-muted); font-weight:600; pointer-events:none;">₱</span>
                                            <input type="text" name="new_billing_amount" id="new_billing_amount"
                                                class="field-input" data-amount inputmode="decimal" placeholder="0.00"
                                    ...
                                    <div class="field-group" style="grid-column:1/-1;">
                                        ...
                                        <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.75rem;">
                                            <div
                                                style="padding:0.875rem 1rem; border:1.5px solid rgba(34,197,94,0.2); border-radius:9px; background:rgba(34,197,94,0.04);">
                                                <p
                                                    style="font-size:0.62rem; font-weight:700; text-transform:uppercase; letter-spacing:0.06em; color:#9ca3af; margin-bottom:0.3rem;">
                                            ...
                                            <div
                                                style="padding:0.875rem 1rem; border:1.5px solid rgba(59,130,246,0.2); border-radius:9px; background:rgba(59,130,246,0.04);">
                                                <p
                                                    style="font-size:0.62rem; font-weight:700; text-transform:uppercase; letter-spacing:0.06em; color:#9ca3af; margin-bottom:0.3rem;">
                                                    Remaining Balance</p>
                                                <p id="billing_remaining_preview"
                                                    style="font-family:'Syne',sans-serif; font-size:1rem; font-weight:800; color:#3b82f6; margin:0;">
                                                    ₱<span
                                                        id="billing_remaining_val">{{ number_format($remainingBal, 2) }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                </div>{{-- /form-card: 171 Billing --}}

                {{-- Advance Billing accordion --}}
                <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(59,130,246,0.18);">
                    <div class="acc-header" id="acc-advance-hdr" onclick="toggleAcc('advance')" role="button"
                        aria-expanded="true" aria-controls="acc-advance-bdy"
                        style="border-bottom-color:rgba(59,130,246,0.15);">
                        <i class="fas fa-money-bill-trend-up"
                            style="color:#2563eb; font-size:0.85rem; flex-shrink:0;"></i>
                        ...
                        @if(!empty($savedAdvancePct))
                            <span class="tag-chip"
                                style="margin-left:0.4rem; background:rgba(59,130,246,0.1); color:#2563eb; border-color:rgba(59,130,246,0.25);">{{ $savedAdvancePct }}%</span>
                        @endif
                        @if(!empty($savedAdvanceAmt))
                            <span class="tag-chip"
                                style="margin-left:0.4rem; background:rgba(59,130,246,0.08); color:#1d4ed8; border-color:rgba(59,130,246,0.16);">₱{{ number_format((float) $savedAdvanceAmt, 2) }}</span>
                        @endif
                        @if(empty($savedAdvancePct) && empty($savedAdvanceAmt))
                            <span style="font-size:0.7rem; color:#9ca3af; margin-left:0.4rem; font-weight:400;">Not
                                set</span>
                        @endif
                        <div class="acc-status-dot"
                            style="background:{{ !empty($savedAdvancePct) ? '#2563eb' : '#d1d5db' }};"></div>
                        <div class="acc-chevron" style="border-color:rgba(59,130,246,0.2);"><i
                                class="fas fa-chevron-down"></i></div>
                    </div>
                    ...
                    <div class="acc-body is-collapsed" id="acc-advance-bdy">
                        <div class="acc-body-inner">
                            <div class="section-body">
                                @if(!empty($savedAdvancePct) || !empty($savedAdvanceAmt))
                                    <div
                                        style="margin-bottom:1rem; padding:0.85rem 1rem; border:1px solid rgba(59,130,246,0.18); border-radius:10px; background:rgba(59,130,246,0.04);">
                                        <p style="font-size:0.8rem; color:#2563eb; font-weight:700; margin:0 0 0.35rem;">
                                            Current Advance Billing</p>
                                ...
                                <div class="grid-2col">
                                    <div class="field-group">
                                        ...
                                        <div style="position:relative;">
                                            <input type="number" name="advance_billing_pct" id="advance_billing_pct"
                                                class="field-input" min="0" max="100" step="0.001" placeholder="e.g. 15"
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div style="position:relative;">
                                            <span
                                                style="position:absolute; left:1rem; top:50%; transform:translateY(-50%); color:var(--ink-muted); font-weight:600; pointer-events:none;">₱</span>
                                            <input type="text" name="advance_billing_amount" class="field-input"
                                                data-amount inputmode="decimal" placeholder="0.00"
                                ...
                                <div
                                    style="padding:0.75rem 1rem; border-left:3px solid #2563eb; background:rgba(59,130,246,0.04); border-radius:6px; margin-top:0.25rem;">
                                    <p
                                        style="font-size:0.75rem; color:var(--text-secondary); margin:0; line-height:1.6;">
                                        <i class="fas fa-info-circle" style="color:#2563eb; margin-right:0.4rem;"></i>
                                        Advance billing is a pre-payment deducted from subsequent billings over the life
                                        of the contract.
                                    </p>
                                </div>
                            </div>
                ...
                </div>{{-- /form-card: Advance Billing --}}

                {{-- Retention accordion --}}
                <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(168,85,247,0.18);">
                    <div class="acc-header" id="acc-retention-hdr" onclick="toggleAcc('retention')" role="button"
                        aria-expanded="true" aria-controls="acc-retention-bdy"
                        ...
                        @if(!empty($savedRetentionPct))
                            <span class="tag-chip"
                                style="margin-left:0.4rem; background:rgba(168,85,247,0.1); color:#9333ea; border-color:rgba(168,85,247,0.25);">{{ $savedRetentionPct }}%</span>
                        @endif
                        @if(!empty($savedRetentionAmt))
                            <span class="tag-chip"
                                style="margin-left:0.4rem; background:rgba(168,85,247,0.08); color:#6d28d9; border-color:rgba(168,85,247,0.16);">₱{{ number_format((float) $savedRetentionAmt, 2) }}</span>
                        @endif
                        ...
                        @endif
                        <div class="acc-status-dot"
                            style="background:{{ !empty($savedRetentionPct) ? '#9333ea' : '#d1d5db' }};"></div>
                        <div class="acc-chevron" style="border-color:rgba(168,85,247,0.2);"><i
                                class="fas fa-chevron-down"></i></div>
                    </div>
                    ...
                    <div class="acc-body is-collapsed" id="acc-retention-bdy">
                        <div class="acc-body-inner">
                            <div class="section-body">
                                @if(!empty($savedRetentionPct) || !empty($savedRetentionAmt))
                                    <div
                                        style="margin-bottom:1rem; padding:0.85rem 1rem; border:1px solid rgba(168,85,247,0.18); border-radius:10px; background:rgba(168,85,247,0.04);">
                                        <p style="font-size:0.8rem; color:#9333ea; font-weight:700; margin:0 0 0.35rem;">
                                            Current Retention</p>
                                        <p style="margin:0; color:var(--text-primary); font-size:0.95rem; line-height:1.5;">
                                ...
                                <div class="grid-2col">
                                    <div class="field-group">
                                        <label class="field-label">Percentage (%)</label>
                                        <div style="position:relative;">
                                            <input type="number" name="retention_pct" id="retention_pct"
                                                class="field-input" min="0" max="100" step="0.001" placeholder="e.g. 10"
                                ...
                                <div
                                    style="padding:0.75rem 1rem; border-left:3px solid #9333ea; background:rgba(168,85,247,0.04); border-radius:6px; margin-top:0.25rem;">
                                    <p
                                        style="font-size:0.75rem; color:var(--text-secondary); margin:0; line-height:1.6;">
                                        <i class="fas fa-info-circle" style="color:#9333ea; margin-right:0.4rem;"></i>
                                        Retention is withheld from each progress billing as a performance guarantee,
                                        released upon project completion and acceptance.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div id="tab-admin" class="tab-content">
                @php
                    ...
                    if (is_string($savedIssuances))
                        $savedIssuances = json_decode($savedIssuances, true) ?? [];
                    if (empty($savedIssuances))
                        $savedIssuances = [''];
                @endphp

                {{-- Contractor Notifications card --}}
                <div class="form-card" style="margin-bottom:1.5rem;">
                    <div class="section-header">
                    ...
                    <div class="section-body">
                        <p class="field-hint" style="margin-bottom:1rem;">Notices and formal documents issued to the
                            contractor</p>
                        <div id="issuances-list" style="display:flex; flex-direction:column; gap:0.75rem;">
                            @foreach($savedIssuances as $val)
                                <div class="dynamic-row">
                                    ...
                                    <button type="button" class="remove-btn" onclick="removeIssuanceRow(this)">
                        ...
                        {{-- Performance Bond date (shown only when selected) --}}
                        <div id="performance-bond-date-field"
                            style="display:none; margin-top:1.25rem; padding:1rem 1.15rem; border-radius:10px; border:1.5px solid rgba(249,115,22,0.2); background:rgba(249,115,22,0.04);">
                            <div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:0.75rem;">
                                <div
                                    style="width:26px; height:26px; background:rgba(249,115,22,0.1); border-radius:7px; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                ...
                </div>{{-- /form-card: Contractor Notifications --}}
                ...
                <div class="form-card" style="margin-bottom:2rem;">
                    <div class="section-header">
                        ...
                        <span
                            style="margin-left:auto; font-size:0.7rem; color:#9ca3af; font-weight:400;">(Optional)</span>
                    </div>
                    <div class="section-body">
    ...
    {{-- ============================================================
    RUNTIME JS VARIABLES (blade-rendered, must precede edit.js)
    ============================================================ --}}
    @push('scripts')
        <script>
    ...
    <x-modal id="reason-intercept-modal" title="Reason / Coverage" type="default" icon="fa-comment-alt" size="md">
        <div style="display:flex; flex-direction:column; gap:1rem;">
            ...
            <div
                style="display:flex; align-items:center; gap:0.6rem; padding:0.75rem 1rem; border-radius:9px; background:var(--bg-secondary); border:1.5px solid var(--border);">
            ...
            <div>
                ...
                <div style="display:flex; align-items:center; justify-content:space-between; margin-top:0.3rem;">
                    <p id="rim-error"
                        style="display:none; font-size:0.72rem; color:#ef4444; margin:0; align-items:center; gap:0.3rem;">
            ...
            <div
                style="padding:0.75rem 1rem; border-left:3px solid var(--orange-500); background:rgba(249,115,22,0.04); border-radius:6px;">
                <p style="font-size:0.75rem; color:var(--text-secondary); margin:0; line-height:1.6;">
                    ...
                    This reason will be logged to <strong style="color:var(--text-primary);">Remarks &amp;
                        Observations</strong> with a timestamp.
                </p>
            </div>
        </div>
    ...
    <x-modal id="edit-entry-modal" title="Edit Entry" type="default" icon="fa-pen" size="md">
        <form id="edit-entry-form" method="POST" action="" style="display:contents;">
            ...
            <div style="display:flex; flex-direction:column; gap:1.1rem;">
                <div>
                    <label
                        style="display:block; font-size:0.7rem; font-weight:700; text-transform:uppercase; letter-spacing:0.06em; color:var(--ink-muted); margin-bottom:0.4rem;">Entry</label>
                ...
                <div>
                    ...
                    <div style="position:relative;">
                        <span
                            style="position:absolute; left:1rem; top:50%; transform:translateY(-50%); color:var(--ink-muted); font-weight:600; pointer-events:none; font-size:0.9rem;">₱</span>
                        <input type="text" id="edit_cost" name="edit_cost" data-amount inputmode="decimal"
                            placeholder="0.00"
                ...
                <div>
                    ...
                    <textarea id="edit_reason" name="edit_reason" rows="3"
                    ...
                    <div style="display:flex; align-items:center; justify-content:space-between; margin-top:0.3rem;">
                        <p id="edit_reason_error"
                            style="display:none; font-size:0.68rem; color:#ef4444; margin:0; align-items:center; gap:0.3rem;">
                            <i class="fas fa-exclamation-circle"></i> Please provide a reason or coverage description.
                        </p>
                        <span style="margin-left:auto; font-size:0.65rem; color:#9ca3af;">
                            <span id="edit_reason_count">0</span> chars
                        </span>
                    </div>
                </div>
            </div>
    ...
    {{-- Edit Entry Modal JS (uses blade-rendered routes — must stay in blade) --}}
    <script>
        ...
        function submitEditEntry() {
            ...
            if (!reason) {
                ...
                if (reasonEl) { reasonEl.style.borderColor = '#ef4444'; reasonEl.style.boxShadow = '0 0 0 3px rgba(239,68,68,0.1)'; reasonEl.focus(); }
                return;
            }
    ...
    <x-modal id="billing-edit-modal" title="Edit Billing Entry" type="default" icon="fa-pen" size="md">
        <div style="display:flex; flex-direction:column; gap:1.1rem;">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                <div>
                    ...
                    <div style="position:relative;">
                        <span
                            style="position:absolute; left:1rem; top:50%; transform:translateY(-50%); color:var(--ink-muted); font-weight:600; pointer-events:none;">₱</span>
                        <input type="text" id="billing-edit-amount" data-amount inputmode="decimal" placeholder="0.00"
                ...
                <div>
                    <label
                        style="display:block; font-size:0.7rem; font-weight:700; text-transform:uppercase; letter-spacing:0.06em; color:var(--ink-muted); margin-bottom:0.4rem;">Billing
                        Date</label>
            ...
            <p id="billing-edit-error"
                style="display:none; font-size:0.75rem; color:#ef4444; align-items:center; gap:0.3rem;">
    ...
    @if($project->status === 'completed')
        <form id="reactivate-form" method="POST" action="{{ route('admin.projects.reactivate', $project) }}"
            style="display:none;">
            @csrf
            @method('PATCH')
        </form>
