...
<div class="max-w-5xl mx-auto fade-up" style="padding:0 1.5rem;">
    ...
    <form method="POST" action="{{ route('admin.projects.update', $project) }}">
                    ...
                    <div class="grid-2col">
                        ...
                        <div class="field-group">
                            ...
                            @if($project->revised_contract_expiry)
                                <p style="font-size:0.9rem; font-weight:700; color:#f97316; margin:0; padding:0.1rem 0; font-family:'Syne',sans-serif;">
        ...
        <div id="tab-progress" class="tab-content">
            ...
            <div class="form-card" style="margin-bottom:1.5rem;">
                ...
                <div class="section-body">
                    <div class="grid-2col">
                        <div class="field-group">
                            ...
                            <div class="prog-bar-track">
                                <div class="prog-bar-fill" id="ap_bar" style="background:var(--orange-500); width:{{ $project->as_planned }}%;"></div>
                            </div>
                            @error('as_planned')
                                <p class="field-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</p>
                            @enderror
                        ...
                        <div class="field-group">
                            ...
                            <input type="number" name="work_done" id="work_done" class="field-input"
                                ...
                                oninput="if(parseFloat(this.value)>100)this.value=100; computeSlippage()">
                            <div class="prog-bar-track">
                                <div class="prog-bar-fill" id="wd_bar" style="background:#3b82f6; width:{{ $project->work_done }}%;"></div>
                            </div>
                            @error('work_done')
                                <p class="field-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</p>
                            @enderror
                    ...
                    <div class="field-group">
                        <label class="field-label">
                            Schedule Slippage <span style="font-weight:400; text-transform:none; letter-spacing:0; color:#9ca3af;">(automatic)</span>
                        </label>
                        ...
                        <div id="slippage-display" style="display:flex; align-items:center; justify-content:space-between; padding:0.85rem 1rem; border:1.5px solid rgba(26,15,0,0.08); border-radius:9px; background:var(--bg-secondary); min-height:48px;">
                            <p id="slippage_label" style="font-size:0.85rem; font-weight:600; color:#9ca3af; margin:0;">
                    ...
                    <div class="field-group">
                        ...
                        <div class="info-box">
                            ...
                            <span style="font-size:0.845rem; color:var(--text-secondary);">
                                ...
                                — <span style="color:var(--orange-600); font-weight:600;">{{ $project->progress_updated_at->diffForHumans() }}</span>
                            </span>
                        </div>
                    </div>
                    @endif
            ...
            <div class="form-card" style="margin-bottom:1.5rem;">
                ...
                <div class="section-body">
                    <div class="grid-2col">
                        ...
                        <div class="field-group">
                            <label class="field-label">
                                Unworked (%) <span style="font-weight:400; text-transform:none; letter-spacing:0; color:#9ca3af;">(auto)</span>
                            </label>
                        ...
                        <div class="field-group">
                            <label class="field-label">
                                Days Overdue <span style="font-weight:400; text-transform:none; letter-spacing:0; color:#9ca3af;">(auto)</span>
                            </label>
                        ...
                        <div class="field-group">
                            <label class="field-label">
                                LD per Day (₱) <span style="font-weight:400; text-transform:none; letter-spacing:0; color:#9ca3af;">(auto)</span>
                            </label>
                        ...
                        <div class="field-group" style="grid-column:1/-1;">
                            <label class="field-label">
                                Total LD (₱) <span style="font-weight:400; text-transform:none; letter-spacing:0; color:#9ca3af;">(auto)</span>
                            </label>
        ...
        <div id="tab-extensions" class="tab-content">
            ...
            <div class="form-card" style="margin-bottom:1.5rem;">
                <div class="acc-header" id="acc-te-hdr"
                     onclick="toggleAcc('te')" role="button" aria-expanded="true" aria-controls="acc-te-bdy">
                ...
                <div class="section-body">
                    ...
                    <p style="font-size:0.65rem; font-weight:700; text-transform:uppercase; letter-spacing:0.08em; color:#9ca3af; margin-bottom:0.875rem; display:flex; align-items:center; gap:0.5rem;">
                        ...
                        <span style="font-weight:500; color:#9ca3af; text-transform:none; letter-spacing:0;">
                            — will be saved as <strong style="color:var(--orange-600);">TE {{ $nextTeNumber }}</strong>
                        </span>
                    </p>
                    <div class="grid-2col">
                        <div class="field-group">
            ...
            <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(99,102,241,0.18);">
                <div class="acc-header acc-indigo" id="acc-vo-hdr"
                     onclick="toggleAcc('vo')" role="button" aria-expanded="true" aria-controls="acc-vo-bdy"
                ...
                <div class="section-body">
                    ...
                    <p style="font-size:0.65rem; font-weight:700; text-transform:uppercase; letter-spacing:0.08em; color:#9ca3af; margin-bottom:0.875rem; display:flex; align-items:center; gap:0.5rem;">
                        ...
                        <span style="font-weight:500; color:#9ca3af; text-transform:none; letter-spacing:0;">
                            — will be saved as <strong style="color:#6366f1;">VO {{ $nextVoNumber }}</strong>
                        </span>
                    </p>
                    <div class="grid-2col">
                        <div class="field-group">
            ...
            <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(234,179,8,0.2);">
                <div class="acc-header acc-yellow" id="acc-so-hdr"
                     onclick="toggleAcc('so')" role="button" aria-expanded="true" aria-controls="acc-so-bdy"
                ...
                <div class="section-body">
                    <div class="grid-2col">
                        <div class="field-group">
                            <label class="field-label">
                                {{ $hasSO ? 'Additional' : '' }} Suspension Days <span style="color:#ef4444;">*</span>
                            </label>
        ...
        @endphp
            ...
            <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(34,197,94,0.18);">
                <div class="acc-header" id="acc-billing-hdr"
                     onclick="toggleAcc('billing')" role="button" aria-expanded="true" aria-controls="acc-billing-bdy"
                ...
                <div class="section-body">
                    ...
                    <div style="margin-bottom:1.5rem;">
                        ...
                        <div style="margin-top:0.75rem; padding:0.875rem 1rem; border-radius:10px; display:flex; align-items:center; justify-content:space-between;
            ...
            <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(59,130,246,0.18);">
                <div class="acc-header" id="acc-advance-hdr"
                     onclick="toggleAcc('advance')" role="button" aria-expanded="true" aria-controls="acc-advance-bdy"
                ...
                <div class="section-body">
                    ...
                    <div style="padding:0.75rem 1rem; border-left:3px solid #2563eb; background:rgba(59,130,246,0.04); border-radius:6px; margin-top:0.25rem;">
                        <p style="font-size:0.75rem; color:var(--text-secondary); margin:0; line-height:1.6;">
                            ...
                            Advance billing is a pre-payment deducted from subsequent billings over the life of the contract.
                        </p>
                    </div>
                </div>
                </div>
            ...
            <div class="form-card" style="margin-bottom:1.5rem; border-color:rgba(168,85,247,0.18);">
                <div class="acc-header" id="acc-retention-hdr"
                     onclick="toggleAcc('retention')" role="button" aria-expanded="true" aria-controls="acc-retention-bdy"
                ...
                <div class="section-body">
                    ...
                    <div style="padding:0.75rem 1rem; border-left:3px solid #9333ea; background:rgba(168,85,247,0.04); border-radius:6px; margin-top:0.25rem;">
                        <p style="font-size:0.75rem; color:var(--text-secondary); margin:0; line-height:1.6;">
                            ...
                            Retention is withheld from each progress billing as a performance guarantee, released upon project completion and acceptance.
                        </p>
                    </div>
                </div>
                </div>
