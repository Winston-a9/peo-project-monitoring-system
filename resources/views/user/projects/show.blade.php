...
<x-slot name="header">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p style="color:#6b4f35; font-size:0.82rem; margin-top:3px;">Project details — read-only</p>
        </div>
        <div style="display:flex; gap:0.6rem; align-items:center;">
            {{-- Read-only badge --}}
            <span style="display:inline-flex; align-items:center; gap:0.35rem; padding:0.4rem 0.875rem; background:rgba(249,115,22,0.08); border:1.5px solid rgba(249,115,22,0.2); border-radius:9px; font-size:0.775rem; font-weight:600; color:var(--orange-600);">
...
<style>
    ...
    .doc-row { display:flex; align-items:center; justify-content:space-between; gap:0.75rem; padding:0.6rem 0.875rem; background:#fffaf5; border:1px solid var(--border); border-radius:9px; }
    ...
    .issue-row { display:flex; align-items:center; gap:0.6rem; padding:0.6rem 0.875rem; background:#fffaf5; border:1px solid var(--border); border-radius:9px; }
</style>
